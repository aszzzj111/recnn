...
def create_RepVGG_A0(inputs, deploy=False):
    ...
    output1 = KL.Dense(2)(output1)
    return [output1, C2, C3, C4, C5]
...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        output2 = list(zip(*layer_outputs))
        output2 = [KL.Concatenate(axis=1, name=n)(list(o))
                   for o, n in zip(output2, output_names)]
        print("打印由rpn得到的每个特征图的得分等", output2)
        rpn_class_logits, rpn_class, rpn_bbox = output2
