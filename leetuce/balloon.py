...
训练配置参数
train
--dataset=E:/fffffile/train/
--weights=E:/fffffile/re-Mask_RCNN-2.1/mask_rcnn_coco.h5
测试配置参数
splash
--weights=E:/fffffile/re-Mask_RCNN-2.1/samples/lettuce/logs/balloon20230608T1330/mask_rcnn_balloon_0019.h5
--image=E:/fffffile/datasets/train/RGB_112.png
...
class BalloonDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        self.add_class("balloon", 1, "lettuce")
        ...
        annotations = []
        annotation = json.load(open(os.path.join(dataset_dir, "train", "via_region_data.json")))
...
if __name__ == '__main__':
    ...
    if args.weights.lower() == "coco":
        ...
        # model.load_weights(weights_path, by_name=True)
         model.load_weights(weights_path, by_name=True, skip_mismatch=True, exclude=["mrcnn_class_logits", "mrcnn_bbox_fc","mrcnn_bbox", "mrcnn_mask"])
